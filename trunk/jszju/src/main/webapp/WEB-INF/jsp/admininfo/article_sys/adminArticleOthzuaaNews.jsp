...
<html:html>
        <script language="JavaScript" type=text/JavaScript>
            function doSelect(channelId) {
                ...
                document.forms[0].action = "ArticleContentEdit.do?channelId="+channelId;
...
<body>
	...
	<div class="mainContent">
	    <!-- start #mainContent -->
		<div class="warp">
		    <span class="title">各地校友会信息文章搜索</span>
		...
		<div class="warp">
	        <span class="title">各地校友会信息文章列表</span>
