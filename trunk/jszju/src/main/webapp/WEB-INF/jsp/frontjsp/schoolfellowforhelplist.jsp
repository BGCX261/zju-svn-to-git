...
<html:html>
        <script language="JavaScript" type=text/JavaScript>
            ...
            function doEdit(id) {
                ...
                document.forms[0].action = "schoolfellowinfocommit.do?id="+id;
                document.forms[0].submit();
            }
...
<body>
	...
	<div class="mainContent">
	    <!-- start #mainContent -->
		<div class="warp">
		    <span class="title">校友发布合作信息搜索</span>
		...
		<div class="warp">
	        ...
	        <logic:notEmpty name="schoolFellowForHelpListForm" property="resultList">
	            ...
	            <tr>
	                ...
	                <td><bean:write name="domain" property="visittimes" /></td>
	                <td>
