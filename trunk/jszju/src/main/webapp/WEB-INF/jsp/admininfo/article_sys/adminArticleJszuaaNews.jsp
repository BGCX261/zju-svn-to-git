...
<html:html>
        <script language="JavaScript" type=text/JavaScript>
            ...
            function doAdd() 
            {
                ...
                document.forms[0].action = "ArticleContentAddEdit.do?channelId="+'${chaid}';
                document.forms[0].submit();
            }
...
<body>
	...
	<div class="mainContent">
	    <!-- start #mainContent -->
		<div class="warp">
		    <span class="title">本会新闻文章搜索</span>
		    ...
		    <fieldset class="inputStyle">
		        ...
		        <div class="bcR">
		            <input class="btn" onclick="doSelect(${chaid})" type="button" value="查询" />
		        </div>
		    </fieldset>
		</div>
		<div class="warp">
