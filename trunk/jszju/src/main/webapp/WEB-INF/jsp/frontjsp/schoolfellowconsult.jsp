...
<script language="JavaScript" type=text/JavaScript>
     ...
     if(document.getElementsByName("domain.title")[0].value=="")
     	...
     	document.forms[0].actionType.value="consul"
...
<div class="topmenu cbody1">
	<ul>
	  ...
	  <li class="thisclass"><a>校友咨询与求助信息发布中心</a></li>
	</ul>
</div>
<!--导航栏End--><!--页头End-->
...
<html:form action="/schoolfellowinforhelp.do" method="post"
  ...
  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
	...
	<td width="20%" height="30" align="right" bgcolor="#F9F9F9">内容：</td>
	  <td width="80%" bgcolor="#FFFFFF">&nbsp;
	  <html:textarea rows="10" property="domain.content" cols="100%"/></td>
	</tr>
	<tr>
