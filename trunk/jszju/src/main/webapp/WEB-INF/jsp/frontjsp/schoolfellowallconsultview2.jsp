		...
		<div class="page_row">
			<div class="page_main_msg left">
				...
				<div class="left_row">
					...
					<c:forEach var="domain" items="${resultList}"
									varStatus="status">
							...
							<div class="c1-body">
								<div class="c1-bline" style="padding:3px 0px;">
									<div class="f-left">
										...
										<a href="<%=request.getContextPath()%>/linkToView.do?consultview=${domain.id}"
...
<div class="right">
				<div class="list news_history">
					...
					<c:forEach var="dyList" items="${consultlist}">
					<c:if test="${count1<15}">
						...
						<div class="list_content">
							<div class="c1-body">
								<div class="" style="padding: 2px 0px; text-align: left;">
									&middot;
									<a
										href="<%=request.getContextPath()%>/linkToView.do?consultview=${dyList.id}"
