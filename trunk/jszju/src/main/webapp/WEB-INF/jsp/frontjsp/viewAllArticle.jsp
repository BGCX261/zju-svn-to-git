...
<body xmlns="">
<!--主体下Begin-->
 <html:form action="/viewAllArticle.do" method="post" target="_self">
							...
							<div class="c1-body">
								<div class="c1-bline" style="padding:3px 0px;">
									<div class="f-left">
										...
										<a href="<%=request.getContextPath()%>/linkToView.do?actionType=${domain.id}"
...
<div class="right">
				<div class="list news_history">
					...
					<c:forEach var="dyList" items="${resultList}">
					<c:if test="${count1<15}">
