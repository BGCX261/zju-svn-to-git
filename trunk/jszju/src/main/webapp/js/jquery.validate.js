...
$.extend($.validator, {
	...
	prototype: {
		...
		defaultMessage: function( element, method) {
			//alert(this.customMetaMessage( element, method ))
		...
		getLength: function(value, element) {
			...
			return value.replace(/[^\x00-\xff]/g,"***").length;//mod by fengjingzhun: 1 utf-8 character = 3 ascii character
		},
	...
	methods: {
		...
		double12: function(value,element)
        {
        return this.optional(element) || /^[-+]?(\d{1,12}(\.\d{1,2})?|\.\d{2})[dD]?$/.test(value);
        },
