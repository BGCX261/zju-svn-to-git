...
<script src="<%=request.getContextPath()%>/front_res/jquery.js"
 ...
 <body style="background-color:#ffffff">
  <div class="c1-body">
							<c:forEach var="fhlist" items="${forhelplist}" varStatus="status" >
									<div class="" style="padding: 3px 0px;">
										<div class="f-left">
											...
											<a
												href="http://www.jszuaa.com:8022/itcastbbs_beta/article.do?method=showTopic&pageNum=1&id=${fhlist.id}"
