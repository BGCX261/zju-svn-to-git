		...
		<div class="page_row">
			<div class="page_main_msg left">
				<div class="list_bar" style="width: 680px;">
					<a href="http://www.jszuaa.com" target="_blank">首页</a> &gt;
					<a >动态信息</a>
				</div>
				<div class="left_row">
					<img
						src="<%=request.getContextPath()%>/res_base/jeecms_com_www/default/article/img/mainpage1.png" />
				</div>
				<div class="left_row">
				<c:forEach var="menuList"
						items="${dynamicMenuForm.menuDomainList[0].menuList}">
					<div class="list pic_news" style="margin-top: 5px">
						...
						<c:forEach var="dyList" items="${dynamicList}">
								<c:if test="${menuList.id==dyList.channelId }">
								<c:if test="${count<6}">
							...
							<div class="c1-body">
								<div class="c1-bline" style="padding:3px 0px;">
									<div class="f-left">
										...
										<a href="<%=request.getContextPath()%>/linkToView.do?actionType=${dyList.id}"
