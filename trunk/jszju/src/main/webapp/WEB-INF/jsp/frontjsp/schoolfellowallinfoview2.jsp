...
<body xmlns="">
<!--主体下Begin-->
 <html:form action="/schoolfellowinfocommit.do" method="post" target="_self">
			...
			<div class="page_main_msg left">
				...
				<div class="left_row">
					<div class="list pic_news" style="margin-top: 5px">
						 <logic:notEmpty name="schoolFellowForHelpListForm" property="resultList">
	            <logic:iterate id="domain" name="schoolFellowForHelpListForm" property="resultList">
							...
							<div class="c1-body">
								<div class="c1-bline" style="padding:3px 0px;">
									<div class="f-left">
										...
										<a href="<%=request.getContextPath()%>/linkToView.do?forhelpview=${domain.id}"
...
<div class="right">
				<div class="list news_history">
					...
					<c:forEach var="dyList" items="${infolist}">
					<c:if test="${count1<15}">
						...
						<div class="list_content">
							<div class="c1-body">
								<div class="" style="padding: 2px 0px; text-align: left;">
									&middot;
									<a
										href="<%=request.getContextPath()%>/linkToView.do?orhelpview=${dyList.id}"
